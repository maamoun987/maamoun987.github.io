...
if (window.location.href === 'https://ir-appointment.visametric.com/en') {
    $(document).ready(function () {

	function selectStudy() {			
		const nextnationalBtn = $('#nationalBtn')
		nextnationalBtn.trigger('click')
		selectOther()
	}
			
	function selectOther() {
		const nextresult1 = $('#result1')
		const nextresult4 = $('#result4')
		const nextresult5 = $('#result5')
		const nextbtnSubmit = $('#btnSubmit')				
		nextresult1.trigger('click')
		nextresult4.trigger('click')
		nextresult5.trigger('click')
		nextbtnSubmit.trigger('click')
	}
	})
}
